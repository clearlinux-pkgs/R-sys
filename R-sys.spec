...
Version  : 3.4.2
Release  : 44
URL      : https://cran.r-project.org/src/contrib/sys_3.4.2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/sys_3.4.2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1685648316
